...
-- Equation(s):
-- \inst3|Equal0~0_combout\ = (\inst3|count_10Hz\(18) & (!\inst3|count_10Hz\(20) & (\inst3|count_10Hz\(21) & !\inst3|count_10Hz\(19))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|count_10Hz\(18),
	datab => \inst3|count_10Hz\(20),
	datac => \inst3|count_10Hz\(21),
	datad => \inst3|count_10Hz\(19),
...
-- Equation(s):
-- \inst3|Equal0~1_combout\ = (!\inst3|count_10Hz\(14) & (!\inst3|count_10Hz\(15) & (\inst3|count_10Hz\(17) & !\inst3|count_10Hz\(16))))
...
PORT MAP (
	dataa => \inst3|count_10Hz\(14),
	datab => \inst3|count_10Hz\(15),
	datac => \inst3|count_10Hz\(17),
	datad => \inst3|count_10Hz\(16),
...
-- Equation(s):
-- \inst3|Equal0~2_combout\ = (!\inst3|count_10Hz\(12) & (\inst3|count_10Hz\(10) & (!\inst3|count_10Hz\(11) & \inst3|count_10Hz\(13))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|count_10Hz\(12),
	datab => \inst3|count_10Hz\(10),
	datac => \inst3|count_10Hz\(11),
	datad => \inst3|count_10Hz\(13),
...
-- Equation(s):
-- \inst3|Equal0~3_combout\ = (!\inst3|count_10Hz\(6) & (!\inst3|count_10Hz\(9) & (\inst3|count_10Hz\(8) & \inst3|count_10Hz\(7))))
...
PORT MAP (
	dataa => \inst3|count_10Hz\(6),
	datab => \inst3|count_10Hz\(9),
	datac => \inst3|count_10Hz\(8),
	datad => \inst3|count_10Hz\(7),
...
-- Equation(s):
-- \inst3|Equal0~5_combout\ = (\inst3|count_10Hz\(3) & (\inst3|count_10Hz\(4) & (\inst3|count_10Hz\(2) & !\inst3|count_10Hz\(5))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst3|count_10Hz\(3),
	datab => \inst3|count_10Hz\(4),
	datac => \inst3|count_10Hz\(2),
	datad => \inst3|count_10Hz\(5),
...
-- Equation(s):
-- \inst3|Equal0~6_combout\ = (\inst3|count_10Hz\(0) & (\inst3|count_10Hz\(1) & (\inst3|Equal0~5_combout\ & \inst3|Equal0~4_combout\)))
...
-- Equation(s):
-- \inst2~0_combout\ = (\enable~input_o\) # ((!\inst|temp\(3)) # (!\inst|temp\(0)))
...
-- Equation(s):
-- \inst3|Equal1~0_combout\ = (\inst3|count_1Hz\(24) & (!\inst3|count_1Hz\(23) & (\inst3|count_1Hz\(21) & \inst3|count_1Hz\(22))))
...
PORT MAP (
	dataa => \inst3|count_1Hz\(24),
	datab => \inst3|count_1Hz\(23),
	datac => \inst3|count_1Hz\(21),
...
-- Equation(s):
-- \inst3|Equal1~2_combout\ = (\inst3|count_1Hz\(14) & (\inst3|count_1Hz\(16) & (!\inst3|count_1Hz\(15) & \inst3|count_1Hz\(13))))
...
PORT MAP (
	dataa => \inst3|count_1Hz\(14),
	datab => \inst3|count_1Hz\(16),
	datac => \inst3|count_1Hz\(15),
...
-- Equation(s):
-- \inst3|Equal1~3_combout\ = (!\inst3|count_1Hz\(9) & (!\inst3|count_1Hz\(10) & (\inst3|count_1Hz\(12) & \inst3|count_1Hz\(11))))
...
PORT MAP (
	dataa => \inst3|count_1Hz\(9),
	datab => \inst3|count_1Hz\(10),
	datac => \inst3|count_1Hz\(12),
	datad => \inst3|count_1Hz\(11),
	combout => \inst3|Equal1~3_combout\);

-- Location: LCCOMB_X39_Y15_N28
\inst3|Equal1~4\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst3|Equal1~4_combout\ = (\inst3|Equal1~3_combout\ & (\inst3|Equal1~0_combout\ & (\inst3|Equal1~1_combout\ & \inst3|Equal1~2_combout\)))
...
-- Equation(s):
-- \inst3|Equal1~5_combout\ = (!\inst3|count_1Hz\(6) & (!\inst3|count_1Hz\(8) & (!\inst3|count_1Hz\(7) & \inst3|count_1Hz\(5))))
...
-- Equation(s):
-- \inst3|Equal1~6_combout\ = (\inst3|count_1Hz\(1) & (\inst3|count_1Hz\(2) & (\inst3|count_1Hz\(4) & \inst3|count_1Hz\(3))))
...
PORT MAP (
	dataa => \inst3|count_1Hz\(1),
	datab => \inst3|count_1Hz\(2),
	datac => \inst3|count_1Hz\(4),
	datad => \inst3|count_1Hz\(3),
...
-- Equation(s):
-- \inst3|count_10Hz~2_combout\ = (\inst3|Add0~34_combout\ & !\inst3|Equal0~6_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~3_combout\ = (!\inst3|Equal1~7_combout\ & \inst3|Add1~40_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~5_combout\ = (\inst3|Add1~36_combout\ & !\inst3|Equal1~7_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~6_combout\ = (\inst3|Add1~32_combout\ & !\inst3|Equal1~7_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~8_combout\ = (\inst3|Add1~26_combout\ & !\inst3|Equal1~7_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~9_combout\ = (!\inst3|Equal1~7_combout\ & \inst3|Add1~24_combout\)
...
-- Equation(s):
-- \inst3|count_1Hz~11_combout\ = (\inst3|Add1~12_combout\ & !\inst3|Equal1~7_combout\)
...
-- Equation(s):
-- \inst|temp~0_combout\ = (!\inst|temp\(0) & (((!\inst|temp\(3)) # (!\inst|temp\(2))) # (!\inst|temp\(1))))
...
-- Equation(s):
-- \inst|temp~2_combout\ = (\inst|temp\(1) & ((\inst|temp\(2) & (!\inst|temp\(3) & !\inst|temp\(0))) # (!\inst|temp\(2) & ((\inst|temp\(0)))))) # (!\inst|temp\(1) & (((\inst|temp\(2)))))
...
-- Equation(s):
-- \inst|temp~1_combout\ = (\inst|temp\(0) & (((!\inst|temp\(1))))) # (!\inst|temp\(0) & (\inst|temp\(1) & ((!\inst|temp\(3)) # (!\inst|temp\(2)))))
...
-- Equation(s):
-- \inst11|Mux0~0_combout\ = (\inst|temp\(0) & ((\inst|temp\(2)) # ((\inst|temp\(1) & \inst|temp\(3))))) # (!\inst|temp\(0) & ((\inst|temp\(1)) # ((\inst|temp\(3)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111100011101110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst|temp\(1),
...
-- Equation(s):
-- \inst11|Mux1~0_combout\ = (\inst|temp\(3)) # ((!\inst|temp\(1) & (!\inst|temp\(2) & \inst|temp\(0))))
...
-- Equation(s):
-- \inst11|Mux2~0_combout\ = (\inst|temp\(3) & ((\inst|temp\(1)) # ((\inst|temp\(2)) # (!\inst|temp\(0)))))
...
-- Equation(s):
-- \inst11|Mux3~0_combout\ = (\inst|temp\(1) & (\inst|temp\(3))) # (!\inst|temp\(1) & ((\inst|temp\(3) & ((\inst|temp\(2)) # (!\inst|temp\(0)))) # (!\inst|temp\(3) & (\inst|temp\(2) & !\inst|temp\(0)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1100100011011100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst|temp\(1),
...
-- Equation(s):
-- \inst11|Mux4~0_combout\ = (\inst|temp\(3) & (!\inst|temp\(1) & (!\inst|temp\(2) & !\inst|temp\(0)))) # (!\inst|temp\(3) & (((\inst|temp\(2)) # (\inst|temp\(0)))))
...
-- Equation(s):
-- \inst11|Mux5~0_combout\ = (\inst|temp\(2) & (((!\inst|temp\(3))))) # (!\inst|temp\(2) & (!\inst|temp\(1) & ((\inst|temp\(3)) # (\inst|temp\(0)))))
...
-- Equation(s):
-- \inst11|Mux6~0_combout\ = (\inst|temp\(3) & ((\inst|temp\(1)) # ((\inst|temp\(2))))) # (!\inst|temp\(3) & (((!\inst|temp\(2) & \inst|temp\(0)))))
