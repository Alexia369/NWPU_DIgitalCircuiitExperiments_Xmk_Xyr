...
-- Equation(s):
-- \Mux6~0_combout\ = (\data_in[3]~input_o\ & ((\data_in[0]~input_o\ & (\data_in[2]~input_o\ & \data_in[1]~input_o\)) # (!\data_in[0]~input_o\ & (!\data_in[2]~input_o\ & !\data_in[1]~input_o\))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (\data_in[0]~input_o\ & (\data_in[3]~input_o\ & (\data_in[2]~input_o\ & \data_in[1]~input_o\))) # (!\data_in[0]~input_o\ & ((\data_in[2]~input_o\ $ (\data_in[1]~input_o\))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\data_in[2]~input_o\ & (\data_in[0]~input_o\ & ((\data_in[1]~input_o\) # (!\data_in[3]~input_o\)))) # (!\data_in[2]~input_o\ & (\data_in[3]~input_o\ & ((!\data_in[1]~input_o\))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\data_in[3]~input_o\ & (\data_in[0]~input_o\ $ (((!\data_in[1]~input_o\))))) # (!\data_in[3]~input_o\ & (\data_in[1]~input_o\ & ((!\data_in[2]~input_o\) # (!\data_in[0]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1001110100100010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \data_in[3]~input_o\,
